...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/profile', name: 'profile', component: () => import('../views/profile/Index.vue'), meta: { keepAlive: true } },
    ...
    { path: '/community', name: 'community', component: () => import('../views/community/PostList.vue'), meta: { customNav: true, keepAlive: true } },
